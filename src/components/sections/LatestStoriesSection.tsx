          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-6">
                Do you have a story of resilience, innovation, or impact? Share
                it with us to inspire others and potentially receive support for
                your initiatives.
              </p>
